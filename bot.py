    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Support Bot", url="https://t.me/CallDEVbot"),
                        InlineKeyboardButton("Dev Channel", url="https://t.me/HaithamOfficial")
                    ],
                    [
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Bot](https://t.me/CallDEVbot)",
                                     disable_web_page_preview=True)
            return
    ...
    if "aboutbot" in cb_data:
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Dev Channel",
                                             url="https://t.me/HaithamOfficial")
                    ],
                    [
